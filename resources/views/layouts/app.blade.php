                        ...
                        <div class="flex items-center">
                            ...
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <a href="{{ route('pages') }}" class="px-3 py-2 rounded-md text-sm font-medium @if(Route::is('pages')) text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 @else text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 @endif">pages</a>
