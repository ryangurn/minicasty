        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">create episode</h3>
                    <p class="mt-1 text-sm text-gray-600">
                        here you can create the episode
                    </p>
                </div>
            </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input wire:model="audio" type="file" name="audio" class="@error('audio') mb-4 @enderror border-solid border-2 border-grey-light mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md p-2">

                                    @if(method_exists($audio, 'temporaryUrl'))
                                        <div class="mt-4">
                                            <span class="pt-2 pb-2 pl-4 pr-4 rounded-full text-green-700 bg-green-100">audio uploaded, you can listen on the episode information page.</span>
                                        </div>
                                    @endif
